...
function mostrarImagen(event, numeroPiso) {
    ...
    const url = `https://procero.tech/wp-content/uploads/2023/12/G_${caracteristicas}.webp`;
    console.log(url);
    ...
    imagen.onerror = function() {
        ...
        errorMessage.textContent = "El plano solicitado aun no está disponible en la version gratuita ";
        // imageContainer.appendChild(errorMessage);
        
        const solicitarBtn = document.createElement("button");
        solicitarBtn.textContent = "Solicitar Version Premiun";
...
function mostrarImagenEdificio(event, numeroPiso) {
   ...
   const urlEdificio = `https://procero.tech/wp-content/uploads/2023/12/G_${caracteristicasEdificio}.webp`;
